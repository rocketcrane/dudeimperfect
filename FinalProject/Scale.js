...
function resizeImgs() {
  ...
  gbLaunch.resize(width/16, 0);
  gbLaunchGrey.resize(width/16, 0);
  ...
  robotB.resize(0, height/3);
  robotBWin.resize(0, height/3);
  robotBStand.resize(0, height/3);
  robotBShoot.resize(0, height/3);
  // Golf
  imgGB.resize(height*4/189, height*4/189);
  gbBg.resize(width, height);
  robotG.resize(0, height/3);
  robotGWin.resize(0, height/3);
  robotSwing1.resize(0, height/3);
  robotSwing2.resize(0, height/3);
  robotSwing3.resize(0, height/3);
  robotSwing4.resize(0, height/3);
  robotSwing5.resize(0, height/3);
  robotSwing6.resize(0, height/3);
  //Menu Items
  ...
  t1Image.resize(700,500);
  t2Image.resize(700,500);
  t3Image.resize(700,500);
  t4Image.resize(700,500);
  t5Image.resize(700,500);
  t6Image.resize(700,500);
  t7Image.resize(700,500);
  t8Image.resize(700,500);
  t9Image.resize(700,500);
  t10Image.resize(700,500);
  t11Image.resize(700,500);
  t12Image.resize(700,500);
  t13Image.resize(700,500);
  t14Image.resize(700,500);
  t15Image.resize(700,500);
  t16Image.resize(700,500);
  t17Image.resize(700,500);
  t18Image.resize(700,500);
  t19Image.resize(700,500);
}
